...
int ff_id3v2_match(const uint8_t *buf, const char *magic) // 用于检测 ID3v2 标签的。ID3v2 是一种常用于 MP3 文件中的元数据格式
{
...
int ff_id3v2_tag_len(const uint8_t *buf) // 计算 ID3v2 标签的总长度,包括标签头和标签内容
{
