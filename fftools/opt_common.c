...
void show_banner(int argc, char **argv, const OptionDef *options) // 显示程序的横幅信息，包括版本信息、库的信息和版权信息
{
    int idx = locate_option(argc, argv, options, "version"); // 在命令行中定位特定选项,此处是 version
    if (hide_banner || idx)
        return;
