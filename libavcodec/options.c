...
/**
* 分配并初始化 AVCodecContext 结构体
* 用于创建一个新的编解码器上下文
* 
* @param codec 要使用的编解码器,可以为 NULL
* @return 成功返回初始化的 AVCodecContext 指针,失败返回 NULL
* 
* 注意:返回的上下文必须使用 avcodec_free_context() 释放
*/
AVCodecContext *avcodec_alloc_context3(const AVCodec *codec)
{
    // 分配 AVCodecContext 结构体内存
...
const AVClass *avcodec_get_class(void) // 返回 AVCodecContext 的 AVClass
{
