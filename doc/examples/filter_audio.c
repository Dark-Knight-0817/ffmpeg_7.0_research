...
// 输入音频参数
#define INPUT_SAMPLERATE     48000                                          // 采样率   
#define INPUT_FORMAT         AV_SAMPLE_FMT_FLTP                             // 浮点平面格式
#define INPUT_CHANNEL_LAYOUT (AVChannelLayout)AV_CHANNEL_LAYOUT_5POINT0     // 5声道配置

#define VOLUME_VAL 0.90                                                     // 音量缩放因子
